...
export const Edition2025Theme: EditionTheme = {
  ...
  backgroundCredit: {
    ...
    author: 'upklyak',
    label: 'Conveyor belt and assembly machine at factory, plant or warehouse. cartoon interior of workshop production line with automated machinery. Engineering equipment on manufactory',
  },
